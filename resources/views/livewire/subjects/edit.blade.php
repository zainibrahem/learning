                                ...
                                <div class="acc-edit  col-lg-6">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            @php
                                            $newName= ($name1 ? $name1 :$name);
                                            @endphp
                                            <input type="text" class="form-control" placeholder="{{$name}}" value="{{$newName}}"  wire:model="name1"/>
                                            @error('name1')
                                            <span class="error" style="margin-top: 0.25rem;font-size: 0.875em;color: #c03221;">
                                        {{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Stage :</label>
                                            <select class="form-select" placeholder="{{$stage1}}"   wire:model="stage1"  >
                                            ...
                                            @error('stage1')<span class="error" style="margin-top: 0.25rem;font-size: 0.875em;color: #c03221;">{{ $message }}</span>@enderror
                                        </div>
                                        <div class="form-group">
